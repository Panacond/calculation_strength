...
R_i=16
а) для различных условий эксплуатации конструкций — на коэффициент m_b 
...
напряжения от всех нагрузок,— на коэффициент
m_d=1
Расчетные сопротивления,приведенные в таблицах 3,4 и 6,следует разделить на коэффициенты 
надежности по сроку службы \gamma_н(сс)(таблица 12) .
\gamma_h=1
...
def main():
    ...
    for file in os.listdir('.'):
        if fnmatch.fnmatch(file, '*WCC.csv'):
            f += [file]
    for i in f:
